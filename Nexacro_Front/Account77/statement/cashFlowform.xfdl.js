(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_tmpCashFlowStatement", this);
            obj._setContents("<ColumnInfo><Column id=\"ACCOUNT_INNER_CODE\" type=\"INT\" size=\"256\"/><Column id=\"ACCOUNT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"PARENT_ACCOUNT_CODE\" type=\"INT\" size=\"256\"/><Column id=\"CASHFLOW\" type=\"INT\" size=\"256\"/><Column id=\"CASHFLOW_SUMMARY\" type=\"INT\" size=\"256\"/><Column id=\"EARLY_CASHFLOW\" type=\"INT\" size=\"256\"/><Column id=\"EARLY_CASHFLOW_SUMMARY\" type=\"INT\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Button("Button00","1050.00","96","68","40",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("조회");
            ...
            obj = new Calendar("calendar_date","867.00","96","175","40",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("4");
            obj.set_binddataset("ds_tmpCashFlowStatement");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"154\"/><Column size=\"154\"/><Column size=\"154\"/><Column size=\"154\"/><Column size=\"154\"/><Column size=\"154\"/><Column size=\"154\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"과목\"/><Cell col=\"1\" text=\"당기\"/><Cell col=\"2\" text=\"세부금액\"/><Cell col=\"3\" text=\"합계금액\"/><Cell col=\"4\" text=\"전기\"/><Cell col=\"5\" text=\"세부금액\"/><Cell col=\"6\" text=\"합계금액\"/></Band><Band id=\"body\"><Cell text=\"bind:ACCOUNT_NAME\"/><Cell col=\"1\"/><Cell col=\"2\" text=\"bind:CASHFLOW\"/><Cell col=\"3\" text=\"bind:CASHFLOW_SUMMARY\"/><Cell col=\"4\"/><Cell col=\"5\" text=\"bind:EARLY_CASHFLOW\"/><Cell col=\"6\" text=\"bind:EARLY_CASHFLOW_SUMMARY\" displaytype=\"number\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("cashFlowform.xfdl","scripts::commonDate.xjs");
        this.addIncludeScript("cashFlowform.xfdl","scripts::commonOpen.xjs");
        this.registerScript("cashFlowform.xfdl", function() {
        ...
        this.cashFlow_onload = function(obj,e){
        		trace("trace현금흐름표");
        ...
        {
            this.addEventHandler("onload",this.cashFlowform_onload,this);
            this.Button00.addEventHandler("onclick",this.Button00_onclick,this);
        };
        this.loadIncludeScript("cashFlowform.xfdl");
